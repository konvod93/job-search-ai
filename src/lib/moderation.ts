...
2. **scam** — явне шахрайство. Два основні патерни:
   ...
   - **Аномальна зарплата для простої роботи**: зарплата явно не відповідає складності/типу роботи (наприклад, "збірка авторучок вдома — 40000 грн/міс", "клеїти конверти — 30000 грн/міс без досвіду"). Проста надомна/механічна робота з високою фіксованою оплатою — класична приманка (часто веде до шахрайства з передоплатою або втягування в незаконні схеми).
