...
> = {
  ...
  //    його природне місце — категорія "Медицина" (за потреби з
  //    crossListedCategories у "Пасажирський транспорт", якщо роботодавець
  //    хоче охопити й транспортну аудиторію) — а не навпаки.
  passenger_transport: [
    {
