...
// Пари category:subcategory, де кінцевий "роботодавець" по суті приватна
// особа, а не структура — найм фізособою напряму реальний ризик для обох
// сторін (кандидат "з вулиці" без перевірки документів/мед-психогляду
// може бути небезпечною людиною; довірити дитину/дім/безпеку незнайомцю
// без посередника — ризик іншого роду). Публікувати такі вакансії можуть
// тільки верифіковані ЮРОСОБИ (агенції) — навіть верифікований ФОП тут
// недостатньо, бо ФОП — це одна людина, а не структура, що бере на себе
// перевірку кандидатів. Хто не хоче йти через агенцію — може шукати на
