...
export const moderationCategoryEnum = pgEnum("moderation_category", [
  ...
  "spam",
  "exploitation_risk",
  // Вимога виконувати/знати репертуар, публічне виконання якого в
  // Україні обмежене законом (рос. шансон/блатняк, твори виконавців-
  // громадян країни-агресора після 1991 р. тощо) — типовий приклад:
  // вакансія співака в кафе з вимогою репертуару Круга/Кучина. За таке
  // заклади реально штрафують, платформа не повинна нормалізувати такі
  // вимоги в оголошеннях.
